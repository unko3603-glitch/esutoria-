...
def build_html():
    ...
    image_paths = [
        r"C:\Users\Junko\.gemini\antigravity\brain\4bf873ee-63c3-47a4-85e0-b993df8f2eb5\uploaded_image_0_1768576059416.png",
        r"C:\Users\Junko\.gemini\antigravity\brain\4bf873ee-63c3-47a4-85e0-b993df8f2eb5\uploaded_image_1_1768576059416.png",
        r"C:\Users\Junko\.gemini\antigravity\brain\4bf873ee-63c3-47a4-85e0-b993df8f2eb5\uploaded_image_2_1768576059416.png",
        r"C:\Users\Junko\.gemini\antigravity\brain\4bf873ee-63c3-47a4-85e0-b993df8f2eb5\uploaded_image_3_1768576059416.png"
    ]
...
<body>
    <div id="password-gate">
        <div class="pw-box glass">
            ...
            <input type="text" id="pw-input" class="pw-input" placeholder="パスワードを入力" autocomplete="off" autofocus>
    ...
    <div id="main-content" style="display: none;">
        ...
        <img src="data:image/png;base64,{b64_images[0]}" alt="Char 1" class="char-img char1 floating">
        <img src="data:image/png;base64,{b64_images[1]}" alt="Char 2" class="char-img char2 floating">
        <img src="data:image/png;base64,{b64_images[2]}" alt="Char 3" class="char-img char3 floating">
        <img src="data:image/png;base64,{b64_images[3]}" alt="Char 4" class="char-img char4 floating">
    ...
    print("Success: index.html has been built with UTF-8 BOM.")
